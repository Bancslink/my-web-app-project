...
COPY --from=build /app/target/my-web-app-project-1.0.jar $PROJECT_HOME/my-web-app-project.jar

# Expose port 8082
EXPOSE 8082

# Run the my-web-app-project application
CMD ["java", "-jar", "./my-web-app-project.jar"]
